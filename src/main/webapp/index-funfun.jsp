...
<script type="text/javascript">
        ...
        $
            .each(
                ...
                function (index, item) {
                    ...
                    delBtn.attr("delete-fileid", item.id);
            ...
            if (confirm("确定要删除" + fName + "吗？")) {
                $.ajax({
                    url: "${pagaContext.request.contextPath} file/todelete?id=" +
                        +$(this).attr("delete-fileid") + "&jobid=" + jobId,
                    type: "PUT",
                    success: function (result) {
                        alert(result.msg);
                        showPage(currPage);
    ...
    $("#fun-trash").click(function () {
        location.href = "fun-trash.jsp?" + "                           jobId=" + jobid + "&" + "                              password=" + password;
    });
</script>
</body>
</html>